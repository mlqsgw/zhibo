					...
					"videocate"	=>	array(
 					...
 					"video"	=>	array(
							...
							"nodes"	=>	array(
								    ...
								    array("name"=>"小视频管理","module"=>"SmallVideo","action"=>"index"),
							        array("name"=>"小视频评价管理","module"=>"SmallVideoComment","action"=>"index")
							),
					),
    ...
    "caiwu"	=>	array(
        ...
        "groups"	=>	array(
            "caiwu"	=>	array(
                ...
                "key"	=>	"caiwu",
                "nodes"	=>	array(
                    array("name"=>"家族长","module"=>"Familys","action"=>"index"),
                    array("name"=>"结算记录","module"=>"Jsjl","action"=>"index"),
                ),
            ),
        )
    ),
	...
	"xztj"	=>	array(
        ...
        "groups"	=>	array(
            "xztj"	=>	array(
                ...
                "key"	=>	"xztj",
                "nodes"	=>	array(
                    array("name"=>"下载统计列表","module"=>"Android","action"=>"index"),
                ),
            ),
        )
    ),
