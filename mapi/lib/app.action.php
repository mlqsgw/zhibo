...
class appModule extends baseModule
{
	...
	public function init()
	{
		...
		$root['statusbar_color'] = '';// '#55ACEF';//状态栏,颜色
		$root['topnav_color'] = '';//'#55ACEF';//顶部导航栏,颜色
        ...
        if($group_id || $online_group_id){
            ...
            if($group_id){
                ...
                if($ret['GroupInfo'][0]['ErrorCode']){
                    $ret = $api->full_group_create($group_id);
	...
	public function prop(){
		...
		$root['list'] = load_auto_cache("prop_list_new");
