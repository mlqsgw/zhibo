 ...
 */
	public function online_index()
	{
        ...
        $sql_str = "SELECT v.*,u.is_hot_on,".
            "v.watch_number+v.virtual_watch_number+v.robot_num as all_watch_number " .
            " FROM ".DB_PREFIX."video as v left join ".DB_PREFIX."user as u on v.user_id=u.id WHERE 1=1 ";
